...
### Game Center
透過寫平常隨處可見的小遊戲來練習 js，在這 repo 裡有 ooxx、數獨、幾A幾B，之所以會寫這 repo 的啟發是在 YT 上看到
[Build Tic Tac Toe With JavaScript - Tutorial](https://www.youtube.com/watch?v=Y-GkMjUZsmM)。  

由於該 repo 為 js 性質就只有推上 github 存放了，有空的話會整理在 codepen 。
[game center repo link](https://github.com/amoeric/game_center)
