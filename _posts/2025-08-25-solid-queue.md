...
需要設定額外的 connection 給 solid_queue 使用。
...
記得把 bin/jobs 加進 Procfile.dev，執行 `./bin/dev` 的時候可以跑 solid_queue
...
排程順利執行的話，會在終端機看到類似的 log

<img src="/assets/images/solid_queue/2.png" alt="solid_queue_log">
...
改用 solid_queue 後，如果要有類似額外頁面的話會需要裝 [mission_control-jobs](https://github.com/rails/mission_control-jobs)。
